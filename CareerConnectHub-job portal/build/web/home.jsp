<%-- 
    Document   : home
    Created on : Nov 13, 2023, 3:26:42 PM
    Author     : Hp
--%>
      ...
      <div class="container header">
        ...
        <div class="width-25">
            ...
            <% if (session.getAttribute("username") != null) { %>
                <li><a href="http://localhost:8080/Job_Portal/user_profile">Welcome, <%= session.getAttribute("username") %></a></li>
                <li><a href="http://localhost:8080/Job_Portal/logout">Logout</a></li>
            <% } else { %>
                <li><a href="user_login.jsp">Login</a></li>
            <% } %> 
                <i class="fa fa-pencil-square-o" aria-hidden="true"></i><a href="resume.jsp"> Create Resume </a>
        </div>
      </div>
    </div>
  </header>
      ...
      <div class="width-50">
        <div class="recent-job-list">
          <div class="width-100">
            ...
            <p class="job-company">CareerConnectHub Group <i class="fa fa-star" aria-hidden="true"></i> | 234 Reviews </p>
          </div>
          <div class="width-33">
            <i class="fa fa-briefcase" aria-hidden="true"></i> 1 to 4 Years
          </div>
    ...
    <div class="container">
      ...
      <div class="width-25">
        <div class=" company-list">
          <div class="width-100">
            <div class="width-25 company-image">
              <img src="https://imgs.search.brave.com/4XkiX7068m22BBUfuN-Aw4_3_Z_THixkm4lG6ADRN6s/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9sb2dv/dHlwLnVzL2ZpbGUv/aWJtLnN2Zw.svg">
            </div>
            <div class="width-75">
      ...
      <div class="width-25">
        <div class=" company-list">
          <div class="width-100">
            <div class="width-25 company-image">
              <img src="https://imgs.search.brave.com/PPT7-9-VZfK62z3KLwnDVV7uDqWLEqE3D7lnmjF6EVk/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9tZWRp/YS5nZXR0eWltYWdl/cy5jb20vaWQvNDU4/NjE3NzE3L3Bob3Rv/L2FwcGxlLWluYy1s/b2dvLmpwZz9zPTYx/Mng2MTImdz0wJms9/MjAmYz1sVTd5SWZQ/OUM0RlRzbmRlQWxu/em5raFowUjhsc1Ni/ODZtd3V0U2M2UmU0/PQ">
            </div>
            <div class="width-75">
      ...
      <div class="width-25">
        <div class=" company-list">
          <div class="width-100">
            <div class="width-25 company-image">
              <img src="https://imgs.search.brave.com/bdXNQp3vYDz0LlQuC87dDxTpBp3obujy0zDc94EpO8A/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9oaW5k/dWJhYnluYW1lcy5p/bmZvL3dwLWNvbnRl/bnQvdGhlbWVzL2hi/bl9kb3dubG9hZC9k/b3dubG9hZC9pbmZv/cm1hdGlvbi10ZWNo/bm9sb2d5LWNvbXBh/bmllcy9pbmZvc3lz/LWxvZ28ucG5n">
            </div>
            <div class="width-75">
      ...
      <div class="width-25">
        <div class=" company-list">
          <div class="width-100">
            <div class="width-25 company-image">
              <img src="https://imgs.search.brave.com/VjJwCICSnRtllM-SkAXi1CPo4-fpO1G24cr5jAryJyU/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9ndW1s/ZXQuYXNzZXR0eXBl/LmNvbS9hZmFxcy9p/bXBvcnQvYWxsL25l/d3MvaW1hZ2VzL25l/d3Nfc3RvcnlfZ3Jm/eC8yMDE3LzA1LzUw/MzU0L1dpcHJvLU5l/dy1Mb2dvLmpwZz9h/dXRvPWZvcm1hdCxj/b21wcmVzcw">
            </div>
            <div class="width-75">
      ...
      <div class="width-25">
        <div class=" company-list">
          <div class="width-100">
            <div class="width-25 company-image">
              <img src="https://imgs.search.brave.com/vwum5Fk1sHQoFOyC-x_ZIQbf9osRZEGpwPun0WLIPWQ/rs:fit:500:0:0/g:ce/aHR0cHM6Ly9waXhs/b2suY29tL3dwLWNv/bnRlbnQvdXBsb2Fk/cy8yMDIxLzA1L0hD/TF9UZWNobm9sb2dp/ZXNfbG9nby03Njh4/NzY4LmpwZw">
            </div>
            <div class="width-75">
