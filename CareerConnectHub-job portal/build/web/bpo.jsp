<%-- 
    Document   : bpo
    Created on : Nov 15, 2023, 12:04:57 PM
    Author     : Hp
--%>
...
<div class="width-100 recent-job">
    <div class="container">
      <h2 class="recent-job-heading">bpo jobs</h2>
      <p class="recent-job-sub-heading">Get the list of all bpo-related jobs</p>
      <!-----JOB LIST----->
      <div class="width-50">
        <div class="recent-job-list">
          <div class="width-100">
            <h4 class="job-title">Internet Ads Evaluator_US 1.1</h4>
            <p class="job-company"> <i class="fa fa-star" aria-hidden="true"></i> | Saha software solution  </p>
          </div>
          <div class="width-33">
            <i class="fa fa-briefcase" aria-hidden="true"></i> 0-2 Years
          </div>
          <div class="width-33">
            <i class="fa fa-inr" aria-hidden="true"></i>12K15K/monthly
          </div>
          <div class="width-33">
          ...
          <div class="width-100">
            <p class="job-skill">
              <b>Skills : </b>EXCELLENT COMMUNICATION,FLUENCY IN ENGLISH,MS-EXCEL
            </p>
          </div>
          <div class="width-100">
      ...
      <div class="width-50">
        <div class="recent-job-list">
          <div class="width-100">
            <h4 class="job-title">TELECALLING</h4>
            <p class="job-company"><i class="fa fa-star" aria-hidden="true"></i> |CareerConnectHub Group  </p>
          </div>
          <div class="width-33">
            <i class="fa fa-briefcase" aria-hidden="true"></i>0-1 Years
          </div>
          <div class="width-33">
            <i class="fa fa-inr" aria-hidden="true"></i>12k-16k/monthly
          </div>
          <div class="width-33">
      ...
      <div class="width-50">
        <div class="recent-job-list">
          <div class="width-100">
            <h4 class="job-title">BPO Executive</h4>
          ...
          <div class="width-33">
            <i class="fa fa-inr" aria-hidden="true"></i>17k-20k/monthly
          </div>
          <div class="width-33">
          ...
          <div class="width-100">
            <p class="job-skill">
              <b>Skills : </b>lead generation,English,Communication Skills
            </p>
          </div>
          <div class="width-100">
            <a href="apply.jsp" class="job-apply-button">Apply Now</a>
      ...
      <div class="width-50">
        <div class="recent-job-list">
          <div class="width-100">
            <h4 class="job-title">Customer Care Specialist</h4>
            <p class="job-company"> <i class="fa fa-star" aria-hidden="true"></i> cognizant  </p>
          </div>
          <div class="width-33">
            <i class="fa fa-briefcase" aria-hidden="true"></i>0-5 Years
          </div>
          <div class="width-33">
            <i class="fa fa-inr" aria-hidden="true"></i>7k-15k/monthly
          </div>
          <div class="width-33">
      ...
      <div class="width-50">
        <div class="recent-job-list">
          <div class="width-100">
            <h4 class="job-title">Bpo Non Voice Executive (Night Shift)</h4>
      ...
      <div class="width-50">
        <div class="recent-job-list">
          <div class="width-100">
            <h4 class="job-title">Customer Service</h4>
            <p class="job-company"> <i class="fa fa-star" aria-hidden="true"></i> | Airtel .co.in</p>
          </div>
          <div class="width-33">
            <i class="fa fa-briefcase" aria-hidden="true"></i>0-2 Years
          </div>
          <div class="width-33">
            <i class="fa fa-inr" aria-hidden="true"></i>10k-20k/monthly
          </div>
          <div class="width-33">
            <i class="fa fa-map-marker" aria-hidden="true"></i>Remote
          </div>
          <div class="width-100">
            <p class="job-skill">
              <b>Skills : </b>English,Communication Skills,Computer Skills
            </p>
          </div>
          <div class="width-100">
            <a href="apply.jsp" class="job-apply-button">Apply Now</a>
    ...
    <div class="width-50">
        ...
        <% 
            try {
                ...
                String sql = "SELECT * FROM bpojob_table";
      ...
      <div class="container">
        ...
        <div class="width-25">
          ...
          <ul class="footer-list">
            ...
            <a href="terms.jsp"><li>TERMS & CONDITIONS</li>
          </ul>
        </div>
        <div class="width-25">
          <h4>RESOURCES</h4>
