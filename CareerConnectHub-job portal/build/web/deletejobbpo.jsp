<%-- 
    Document   : deletejobbpo
    Created on : Nov 23, 2023, 10:18:18 AM
    Author     : Hp
--%>
...
<header>
    ...
    <div class="login-container">
        <h2>delete job in BPO Section</h2>
        <form action="http://localhost:8080/Job_Portal/deletejobbpo" method="post">
