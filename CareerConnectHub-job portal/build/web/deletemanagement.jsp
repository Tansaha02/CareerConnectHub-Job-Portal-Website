<%-- 
    Document   : deletemanagement
    Created on : Nov 23, 2023, 11:02:00 AM
    Author     : Hp
--%>
...
<header>
    ...
    <div class="login-container">
        <h2>delete job to Management Section</h2>
        <form action="http://localhost:8080/Job_Portal/deletejobmanagement" method="post">
