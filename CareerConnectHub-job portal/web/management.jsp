<%-- 
    Document   : management
    Created on : Nov 20, 2023, 12:34:52 PM
    Author     : Hp
--%>
...
<div class="width-100 banner-section">
    <div class="container">
      <h1 class="banner-heading">Want to make a successful Career in management industry</h1>
...
<div class="width-100 recent-job">
    <div class="container">
      <h2 class="recent-job-heading">Management jobs</h2>
      <p class="recent-job-sub-heading">Get the list of all management-related jobs</p>
      <!-----JOB LIST----->
      <div class="width-50">
