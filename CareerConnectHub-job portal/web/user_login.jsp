<%-- 
    Document   : user_login
    Created on : Nov 13, 2023, 5:26:56 PM
    Author     : Hp
--%>
...
<header>
    ...
    <div class="login-container">
        <h2>User Login</h2>
        <form action="http://localhost:8080/Job_Portal/login" method="post">
        ...
        <div class="options">
            <a href="reg.jsp" class="option-link">New User Registration</a>
            <a href="ValidateEmail.jsp" class="option-link">Forgot Password?</a>
        </div>
    </div>
        <footer>
