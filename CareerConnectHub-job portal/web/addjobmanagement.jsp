...
<%-- 
    Document   : addjobmanagement
    Created on : Nov 22, 2023, 11:04:04 AM
    Author     : Hp
--%>
...
<header>
      ...
      <div class="container header">
        ...
        <div class="width-50">
          <ul class="header-menu ">
            ...
            <li>
              <a href="#width-100 recent-job">Companies </a>
            </li>
            <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Services <span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a href="trainings.html">industrial trainings</a></li>
        ...
        <div class="width-25">
          <a href="#" class="button-job-post">
            <i class="fa fa-shopping-bag"></i>Log In</a>
          <a href="cv.html" class="button-resume">
    ...
    <div class="login-container">
        <h2>Add job to Sales Section</h2>
        <form action="http://localhost:8080/Job_Portal/addjobmanagement" method="post">
