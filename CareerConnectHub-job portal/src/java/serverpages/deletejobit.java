 ...
 * @author Hp
 */
@WebServlet(name = "deletejobit", urlPatterns = {"/deletejobit"})
public class deletejobit extends HttpServlet {
     ...
     */
     protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = "DELETE FROM itjob_table WHERE job_title = ? AND company= ?";
